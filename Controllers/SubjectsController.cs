...
namespace MyLabVar5.Controllers
{
    public class SubjectsController : Controller
    {
        ...
        public SubjectsController(MyLabContext context)
        {
            _context = context;
        }
        ...
        {
            var myLabContext = _context.Subjects.Include(s => s.Group).Include(s => s.Room).Include(s => s.Teacher);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,TeacherId,RoomId,GroupId")] Subject subject)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,TeacherId,RoomId,GroupId")] Subject subject)
        {
            if (id != subject.Id)
            {
                return NotFound();
